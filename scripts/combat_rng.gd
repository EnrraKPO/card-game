...
# the master seed:
#   · rules — every effect-layer chance gate (the dodge and crit rolls were nuked 2026-08-13)
...
# generator, exactly as before. The rules layer runs in the Lab, the forge and deck edits
# too — this class never makes them deterministic, and never has to.
