...
# spotlight pool + arrow scaled to sit inside it, and the hold-progress fill. It borrows
# no cue nodes, and it lives at ONE fixed z for its whole life: above the card badge/tag
